...
- [AI-generated Characterization Tests](../ai-generated-characterization-tests/) — the logical follow-up; once you understand the code with AI, use AI to generate the tests that prove it.
- [Knowledge Graph-Augmented Generation (GraphRAG)](../knowledge-graph-augmented-generation/) — for very large systems, a knowledge graph can help provide the "global" context that an LLM needs for accurate code reading.
- [AI Documentation Generation](../ai-documentation-generation/) — once the AI has explained the code, use it to generate the permanent documentation that was missing.

## What Next

After understanding the legacy module with AI assistance, apply [AI-generated Characterization Tests](../ai-generated-characterization-tests/) to create a safety net before attempting any changes.
