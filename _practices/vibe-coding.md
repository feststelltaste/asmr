...
- **Agentic Coding Workflows** — vibe coding is the "interactive" version of an agentic workflow.
- **Context Engineering** — the "vibe" is only as good as the context (rules, architecture docs) you provide the AI.
- **Harness Engineering** — for high-stakes projects, "vibe coding" must be paired with a "harness" to ensure correctness.

## What Next

After prototyping your first service with **Vibe Coding**, implement **Harness Engineering** to build the structured environment where the "vibe" code can be properly tested and verified.
