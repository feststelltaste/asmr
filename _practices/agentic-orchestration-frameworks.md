...
- **Agentic Coding Workflows** — orchestration frameworks provide the infrastructure for running these workflows at scale.
- **Agent Sandboxing** — any framework-orchestrated agent with shell access must still be sandboxed for security.
- **Human-in-the-Loop Review** — orchestration frameworks should include explicit "interrupt" points for human review of agent decisions.

## What Next

After selecting an orchestration framework, implement **Agentic Coding Workflows** to begin executing your first multi-step modernization tasks.
