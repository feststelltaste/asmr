...
- [Anti-Corruption Layer](../anti-corruption-layer/) — the primary technical pattern for protecting a new domain model from legacy corruption.
- [Strangler Fig Pattern](../strangler-fig-pattern/) — DDD provides the "cuts" for the slices that are strangled from the legacy monolith.
- [AI-assisted Legacy Code Reading](../ai-assisted-legacy-code-reading/) — the technique used to perform the initial "semantic audit" of the legacy system.

## What Next

After identifying your first bounded context, apply [Anti-Corruption Layer](../anti-corruption-layer/) to protect the new service as you begin to migrate logic using the [Strangler Fig Pattern](../strangler-fig-pattern/).
