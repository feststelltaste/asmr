...
- **RAG (Retrieval-Augmented Generation)** — the underlying technique for knowledge recovery.
- **Knowledge Graph-Augmented Generation (GraphRAG)** — provides a more structured way to link non-code context to code entities.
- **AI-assisted Legacy Code Reading** — recovery agents provide the "why," while code reading agents provide the "what."

## What Next

After establishing a basic RAG system for your documentation, begin linking it to your codebase via **Knowledge Graph-Augmented Generation (GraphRAG)** to provide a richer "context map" for your modernization agents.
